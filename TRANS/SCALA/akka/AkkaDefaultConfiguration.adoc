...
Ви можете почати використовувати Akka, не визначаючи жодної конфігурації, оскільки надаються розумні значення за замовчуванням. Пізніше вам може знадобитися змінити налаштування, щоб змінити поведінку за замовчуванням або адаптуватись до конкретних середовищ виконання. Типові приклади налаштувань, які ви можете змінити:

* рівень журналу та резервний реєстратор
* включити кластер
* серіалізатори повідомлень
* налаштування диспетчерів
...
=== Звідки зчитується конфігурація
...
Make your edits/overrides in your application.conf. Don’t override default values if you are not sure of the implications. Akka Config Checker is a useful tool for finding potential configuration issues.
