...
In this chapter you'll learn how to develop in Scala applications that use a graphical user interface
...
based.footnote:[See, for instance, The Java Tutorials. [Jav\]] The Scala wrappers resemble the underlying Swing classes, but try to simplify concepts
