var _RESOURCES = [
      {
        "title":"",
        "titleFriendly":"",
        "summary":"適用於 Android 開發人員的官方網站。提供適用於應用程式開發人員與設計師的 Android SDK 與文件。",
        "url":"intl/zh-tw/index.html",
        "group":"",
        "keywords": [],
        "tags": [],
...
var ABOUT_RESOURCES = [
      ...
      }, 
      {
        ...
        "image":"//chart.googleapis.com/chart?chl=GL%202.0%7CGL%203.0%7CGL%203.1&chf=bg%2Cs%2C00000000&chd=t%3A64.1%2C34.5%2C1.4&chco=c4df9b%2C6fad0c&cht=p&chs=400x250",
        "lang":"en",
        "type":"about"
      }, 
      {
...
var DESIGN_RESOURCES = [
      ...
      }, 
      {
        "title":"Color",
        "titleFriendly":"",
        "summary":"Color Use color primarily for emphasis. Choose colors that fit with your brand and provide good contrast between visual components. Note that red and green may be indistinguishable to color-blind users. Blue is the standard accent color in Android&#39…",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"Responsive Interaction Use illumination and dimming to respond to touches, reinforce the resulting behaviors of gestures, and indicate what actions are enabled and disabled. Be responsive to touches in a gentle way . Whenever a user touches an actionable…",
      ...
      }, 
      {
        "title":"Themes",
        "titleFriendly":"",
        "summary":"Color Themes Themes are Android&#39;s mechanism for applying a consistent style to an app or activity. The style specifies the visual properties of the elements that make up your user interface, such as color, height, padding and font size. To promote…",
      ...
      }, 
      {
        "title":"Your Branding",
        "titleFriendly":"",
        "summary":"Following Android design patterns doesn&#39;t mean that your app has to look the same as everyone else&#39;s. In Android, your app can shine as an extension of your brand. UI Color Application Use your brand color for accent by overriding the Android …",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"Side Nav Creating a Navigation Drawer The navigation drawer is a panel that transitions in from the left edge of the screen and displays the app?s main navigation options. The user can bring the navigation drawer onto the screen by swiping from the left…",
      ...
      }, 
      {
        "title":"Gestures",
        "titleFriendly":"",
        "summary":"Gestures Gestures allow users to interact with your app by manipulating the screen objects you provide. The following table shows the core gesture set that is supported in Android. Triggers the default functionality for a given item. Press, lift Enters…",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"Progress and Activity Progress bars and activity indicators signal to users that something is happening that will take a moment. Progress bars are for situations where the percentage completed can be determined. They give users a quick sense of how much…",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"Sliders Interactive sliders make it possible to select a value from a continuous or discrete range of values by moving the slider thumb. The smallest value is to the left, the largest to the right. The interactive nature of the slider makes it a great…",
...
var DISTRIBUTE_RESOURCES = [
      ...
      {
        "title":"Distributing to Android Auto",
        "titleFriendly":"",
...
var GOOGLE_RESOURCES = [
      ...
      }, 
      {
        "title":"Migration",
        "titleFriendly":"",
        "summary":"Android Cloud to Device Messaging (C2DM) was officially deprecated on June 26, 2012, and will be shut down completely as of July 30, 2015. C2DM developers are strongly encouraged to move to Google Cloud Messaging (GCM) . GCM is the next generation of …",
      ...
      }, 
      {
        "title":"Location APIs",
        "titleFriendly":"",
        "summary":"The location APIs make it easy for you to build location-aware applications, without needing to focus on the details of the underlying location technology. The related Places APIs also help your app identify real-world points of interest near the user…",
      ...
      {
        "title":"SafetyNet for Android",
        "titleFriendly":"",
        "summary":"SafetyNet provides access to Google services that help you assess the health and safety of an Android device. The wide variety of Android devices and configurations can make it difficult to know if your app will behave as you expect on all available devices…",
        "url":"google/play/safetynet/index.html",
        "group":"",
        "keywords": ["compatibility","cts"],
        "tags": ["compatibility","cts"],
        "image":"",
        "lang":"en",
        "type":"google"
      }, 
      {
        "title":"Getting Started with SafetyNet",
        "titleFriendly":"",
        ...
        "url":"google/play/safetynet/start.html",
        "group":"",
        "keywords": [],
        "tags": [],
        "image":"",
...
var DESIGN_BY_TAG = {
    ...
    "textview":[9], 
    "font":[9], 
    "input":[11,34,36,57,58], 
    "button":[11,54,57], 
    "multiplescreens":[12], 
    "layout":[12,25,35,63,64], 
    "tablets":[12], 
    "icons":[14,44], 
    "googleplay":[14], 
    "listing":[14], 
    ...
    "material":[22], 
    "support":[24], 
    "navigation":[25,30,35,36,39,40,41,61], 
    "drawerlayout":[26], 
    "slidingpanelayout":[26], 
    "appwidget":[27], 
    "home":[27], 
    "settings":[28], 
    "preferences":[28,33], 
...
var DISTRIBUTE_BY_TAG = {
    "landing":[8,22], 
    "quality":[8,22,29,46,49,51,52,57,58], 
    "localizing":[15,16], 
    "publishing":[15,16,54], 
    "disttools":[15,16,19,20], 
    "promoting":[18,19,20], 
    "brand":[21], 
    "bugdroid":[21], 
    "assets":[21], 
    "wear":[29,58], 
    "wearables":[29], 
    "monetizing":[32,33,34,35,36], 
    "paid":[32], 
    "in-app":[35,36], 
    "billing":[35], 
    "iap":[35,36], 
    "googleplay":[37,50,55,61,78,79,80], 
    "payments":[37], 
    "giftcard":[37], 
    "analytics":[39,40,41,42,43,44,63,69], 
    "userbehavior":[39,40,41,42,43,44,69], 
    "tv":[46], 
    "publish":[46,52,58], 
    "visibility":[47], 
    "growth":[47,60,61,62,64,65], 
    "distributing":[47], 
    "distribute":[48], 
    "bestpractices":[48], 
    "families":[49,50,51], 
...
var GOOGLE_BY_TAG = {
    ...
    "drm":[49], 
    "oauth2.0":[55,56], 
    "googleauthutil":[55,56]
};

var GUIDE_BY_TAG = {
    "searchrecentsuggestionsprovider":[10,11], 
    "searchrecentsuggestions":[11], 
    "searchview":[12], 
    "devicepolicymanager":[14], 
    "policy":[14], 
    "security":[14], 
    "edittext":[38], 
    "autocompletetextview":[38], 
    "adapterview":[39], 
    "spinneradapter":[39], 
    "button":[40], 
    "imagebutton":[40], 
    ...
    "widget":[50], 
    "preference":[52], 
    "preferenceactivity":[52], 
    "preferencefragment":[52], 
    "clipdata":[53,69], 
    "dragevent":[53], 
    "onlongclicklistener":[53], 
    "gridview":[56], 
    "relativelayout":[57], 
    "linearlayout":[58], 
    "listview":[59], 
    ...
    "valueanimator":[133], 
    "objectanimator":[133], 
    "layouttransition":[133], 
    "viewpropertyanimator":[133], 
    "mediaplayer":[141], 
    "soundpool":[141], 
    "audiomanager":[141], 
    "mediarecorder":[142,145], 
    "audio":[143,186], 
    "video":[143,145,186], 
    "adaptive":[143], 
    "streaming":[143], 
    ...
    "wirelessdisplay":[146], 
    "miracast":[146], 
    "mediarouteprovider":[147], 
    "mediacontrolintent":[147], 
    "sipmanager":[150], 
    "sipprofile":[150], 
    "sipaudiocall":[150], 
    "telephony":[150], 
    "wireless":[151,156,157], 
    "bluetoothadapter":[151,156], 
    "bluetoothdevice":[151,156], 
    "hostcardemulation":[153], 
    "hce":[153], 
    "hostapduservice":[153], 
    "offhostapduservice":[153], 
    "tapandpay":[153], 
    "recents":[164], 
    "overview":[164], 
    "intentfilter":[169,170], 
    "multiplescreens":[175]
};

var SAMPLES_BY_TAG = {
    "lnotificationssample":[0], 
    "basicandroidkeystore":[1], 
    "customnotifications":[2], 
    "camera2basic":[3], 
    "basicrenderscript":[4], 
    "cardemulation":[5], 
    "renderscriptintrinsic":[6], 
    "advancedimmersivemode":[7], 
    "bluetoothadvertisements":[8], 
    "actionbarcompat-styled":[9], 
    "storageclient":[10], 
    "documentcentricrecents":[11], 
    "activityinstrumentation":[12], 
    "basicnotifications":[13], 
    "networkconnect":[14], 
    "elizachat":[15], 
    "permissionrequest":[16], 
    "basictransition":[17], 
    "bluetoothlegatt":[18], 
    "datalayer":[19], 
    "apprestrictionenforcer":[20], 
    "slidingtabscolors":[21], 
    "deviceowner":[22], 
    "displayingbitmaps":[23], 
    "basicaccessibility":[24], 
    "clippingbasic":[25], 
    "jumpingjack":[26], 
    "drawabletinting":[27], 
    "flashlight":[28], 
    ...
    "geofencing":[30], 
    "camera2video":[31], 
    "basicmanagedprofile":[32], 
    "pdfrendererbasic":[33], 
    "basicimmersivemode":[34], 
    "swiperefreshlayoutbasic":[35], 
    "screencapture":[36], 
    "timer":[37], 
    "basiccontactables":[38], 
    "slidingtabsbasic":[39], 
    "elevationdrag":[40], 
    "nfcprovisioning":[41], 
    "watchface":[42], 
    "basicsyncadapter":[43], 
    "basicmediarouter":[44], 
    "activityscenetransitionbasic":[45], 
    "basicgesturedetect":[46], 
    "borderlessbuttons":[47], 
    "actionbarcompat-basic":[48], 
    "bluetoothchat":[49], 
    "messagingservice":[50], 
    "basicmultitouch":[51], 
    "agendadata":[52], 
    "gridviewpager":[53], 
    "xyztouristattractions":[54], 
    "directoryselection":[55], 
    "swiperefreshlistfragment":[56], 
    "mediarouter":[57], 
    "customchoicelist":[58], 
    "quiz":[59], 
    "synchronizednotifications":[60], 
    "speedtracker":[61], 
    "cardviewsample":[62], 
    "apprestrictions":[63], 
    "revealeffectbasic":[64], 
    "hdrviewfinder":[65], 
    "cardreader":[66], 
    "basicmediadecoder":[67], 
    "mediabrowserservice":[68], 
    "elevationbasic":[69], 
    "actionbarcompat-shareactionprovider":[70], 
    "documentcentricrelinquishidentity":[71], 
    "mycloud":[72], 
    "mediaeffects":[73], 
    "repeatingalarm":[74], 
    "wearablenotifications":[75], 
    "textswitcher":[76], 
    "navigationdrawer":[77], 
    "recipeassistant":[78], 
    "horizontalpaging":[79], 
    "mediarecorder":[80], 
    "skeletonwearableapp":[81], 
    "recyclerview":[82], 
    "basicnetworking":[83], 
    "batchstepsensor":[84], 
    "jobscheduler":[85], 
    "appusagestatistics":[86], 
    "swiperefreshmultipleviews":[87], 
    "delayedconfirmation":[88], 
    "actionbarcompat-listpopupmenu":[89], 
    "floatingactionbuttonbasic":[90], 
    "textlinkify":[91], 
    "interpolator":[92], 
    "customtransition":[93], 
    "watchviewstub":[94], 
    "apprestrictionschema":[95], 
    "donebar":[96], 
    "immersivemode":[97], 
    "beamlargefiles":[98], 
    "alwayson":[99], 
...
var TRAINING_BY_TAG = {
    "tv":[9,10,11,12,13,14,15,16,17,169,171,172,173,174,175,176,177,178,179,180,181,184,185,187,188,339], 
    "leanback":[9,13,16,169,179,182,185,188], 
    "edittext":[55], 
    "accessibility":[55], 
    "include":[60], 
    "merge":[60], 
    ...
    "listview":[60], 
    "support":[66,285,339], 
    "testing":[72,260,261,262,263,264,265], 
    "audio":[78,251], 
    "media":[78], 
    "cloud":[82,350], 
    "":[86], 
    ...
    "enterprise":[91], 
    "corporate":[91], 
    "network":[96,161,199,317,324,369], 
    "wireless":[96,161,369], 
    "actionbar":[100,101,102,103,104], 
    "intents":[105,106,107,108,129,346], 
    "layouts":[109,110], 
    "resources":[109,111], 
    "screens":[109], 
    "localization":[109,111], 
    "strings":[111], 
    "localizing":[111], 
    "styles":[112], 
    "fragments":[113,114,115,116,339], 
    "userinterface":[113,193], 
    "supportlibrary":[113], 
    "datastorage":[117,118,119,120], 
    "files":[117], 
    "sql":[117], 
    "database":[117,131], 
    "preferences":[117], 
    "activitylifecycle":[121,122,123,124,125], 
    "sdktools":[126], 
    "ui":[127,145], 
    "emulator":[128], 
    "projectsetup":[130], 
    "searchview":[131], 
    "drawerlayout":[136], 
    "navigation":[136,141,151,382], 
    "upnavigation":[137], 
    "navutils":[137,138], 
    "taskstackbuilder":[137,138], 
    "backnavigation":[138], 
    "viewpager":[139], 
    "horizontal":[139], 
    "paging":[139], 
    ...
    "views":[193], 
    "layout":[193], 
    "notifications":[204,205,206,207,208,209,227,228,229,230,231], 
    "intentservice":[210], 
    "wear":[240,241,242,243,244,245], 
    "privacy":[246], 
    "oauth":[246], 
    "accounts":[246], 
    "auto":[250,251,252,253], 
    "wakelock":[255], 
    "alarmmanager":[255], 
    "wakefulbroadcastreceiver":[255], 
    "location":[267], 
    "geofence":[267], 
    "geofencing":[267], 
    ...
    "ram":[316], 
    "lowmemory":[316], 
    "outofmemoryerror":[316], 
    "ontrimmemory":[316], 
    "threads":[320], 
    "asynctask":[320], 
    "tablet":[339], 
    "multiplescreens":[341,358], 
    "nfcadapter":[354], 
    "androidbeam":[354], 
    "wifi":[369], 
    "threadpool":[373], 
