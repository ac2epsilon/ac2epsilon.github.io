...
var DISTRIBUTE_RESOURCES = [
      ...
      }, 
      {
        ...
        "group":"",
        "keywords": ["engagement","appindexing","search"],
        "tags": ["engagement","appindexing","search"],
...
var PREVIEW_RESOURCES = [
      ...
      }, 
      {
        "title":"Permissions",
        "titleFriendly":"",
        "summary":"The M Developer Preview introduces a new app permissions model which streamlines the process for users to install and upgrade apps. If an app running on the M Preview supports the new permissions model, the user does not have to grant any permissions …",
      ...
      }, 
      {
        "title":"Support",
        "titleFriendly":"",
        "summary":"If you&#39;ve encountered bugs or have feedback about the M Developer Preview, create an issue on our issue tracker. For more support, join the M Developer Preview Google+ community to discuss your development experiences. M Developer Preview, Revision…",
...
var TOOLS_RESOURCES = [
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"This document explains how to use the Data Binding Library to write declarative layouts and minimize the glue code necessary to bind your application logic and layouts. Setting Up Work Environment: To set up your application to use data binding, add data…",
...
var DISTRIBUTE_BY_TAG = {
    "landing":[9,80], 
    "quality":[9,52,54,56,60,62,64,76,80], 
    "analytics":[13,68,69,70,71,73,74], 
    "userbehavior":[13,68,69,70,71,73,74], 
    "engagement":[15,20,22,24], 
    "adwords":[15,30], 
    "":[16,25], 
    "gcm":[18], 
    "google":[19,28,29,36], 
    "identity":[19,28,29,36], 
    "signin":[19,28,36], 
    "updates":[21], 
    "games":[23,39,67], 
    "listing":[26], 
    "googleplay":[26,38,39,40,47,55,66,84], 
    "users":[26,27,30,32,34,35,37], 
    "growth":[26,27,32,34,35,61], 
    "getusers":[31], 
    "search":[31], 
    "appindexing":[31], 
    "localizing":[42,49], 
    "publishing":[42,49,53], 
    "disttools":[42,44,47,49], 
    "promoting":[45,47], 
    "brand":[46], 
    "bugdroid":[46], 
    "assets":[46], 
...
var GUIDE_BY_TAG = {
    ...
    "wi-fip2p":[38], 
    "wifip2p":[38], 
    "hostcardemulation":[42], 
    "hce":[42], 
    "hostapduservice":[42], 
    "offhostapduservice":[42], 
    "tapandpay":[42], 
    "sipmanager":[45], 
    "sipprofile":[45], 
    "sipaudiocall":[45], 
    ...
    "targetsdkversion":[68], 
    "maxsdkversion":[68], 
    "searchrecentsuggestionsprovider":[77,80], 
    "searchrecentsuggestions":[80], 
    "searchview":[81], 
    "sdcard":[82,85], 
    "external":[82], 
    "database":[85], 
    "sharedpreferences":[85], 
    "relativelayout":[90], 
    "gridview":[91], 
    "linearlayout":[92], 
    "listview":[93], 
    ...
    "tabs":[97], 
    "preference":[100], 
    "preferenceactivity":[100], 
    "preferencefragment":[100], 
    "accessibility":[102], 
    "clipdata":[108,141], 
    "dragevent":[108], 
    "onlongclicklistener":[108], 
    "datepicker":[111], 
    "timepicker":[111], 
    "button":[112], 
    "imagebutton":[112], 
    ...
    "radiogroup":[116], 
    "edittext":[117], 
    "autocompletetextview":[117], 
    "input":[138,141], 
    "spellcheckerservice":[138], 
    "ime":[139], 
    "keyboard":[139], 
    "inputmethodservice":[139], 
    "clipboardmanager":[141], 
    "localizing":[152], 
    "localization":[152], 
    "resources":[152], 
    "formats":[152], 
    ...
    "launcher":[171], 
    "home":[172], 
    "appwidgetprovider":[172], 
    "mediarecorder":[173,177], 
    "mediarouteprovider":[175], 
    "mediacontrolintent":[175], 
    "photo":[177], 
    "mediaplayer":[179], 
    "soundpool":[179], 
    "audiomanager":[179], 
    ...
    "valueanimator":[184], 
    "objectanimator":[184], 
    "layouttransition":[184], 
    "viewpropertyanimator":[184], 
    "games":[185], 
    "devicepolicymanager":[191], 
    "policy":[191], 
    "security":[191]
};
...
var SAMPLES_BY_TAG = {
    "basicmultitouch":[0], 
    "advancedimmersivemode":[1], 
    "cardreader":[2], 
    "synchronizednotifications":[3], 
    "swiperefreshmultipleviews":[4], 
    "drawabletinting":[5], 
    "basicsyncadapter":[6], 
    "bluetoothlegatt":[7], 
    "immersivemode":[8], 
    "geofencing":[9], 
    "basiccontactables":[10], 
    "navigationdrawer":[11], 
    "directoryselection":[12], 
    "documentcentricrelinquishidentity":[13], 
    "speedtracker":[14], 
    "basictransition":[15], 
    "revealeffectbasic":[16], 
    "documentcentricrecents":[17], 
    "watchviewstub":[18], 
    "screencapture":[19], 
    "basicmediadecoder":[20], 
    "jobscheduler":[21], 
    "xyztouristattractions":[22], 
    "customtransition":[23], 
    "messagingservice":[24], 
    "slidingtabsbasic":[25], 
    "camera2raw":[26], 
    "mediabrowserservice":[27], 
    "interpolator":[28], 
    "clippingbasic":[29], 
    "actionbarcompat-listpopupmenu":[30], 
    "actionbarcompat-shareactionprovider":[31], 
    "activityinstrumentation":[32], 
    "deviceowner":[33], 
    "textlinkify":[34], 
    "pdfrendererbasic":[35], 
    "apprestrictionschema":[36], 
    "wearablenotifications":[37], 
    "renderscriptintrinsic":[38], 
    "recyclerview":[39], 
    "nfcprovisioning":[40], 
    "apprestrictionenforcer":[41], 
    "basicandroidkeystore":[42], 
    "basicrenderscript":[43], 
    "bluetoothchat":[44], 
    "lnotificationssample":[45], 
    "donebar":[46], 
    "elevationbasic":[47], 
    "findmyphone":[48], 
    "mycloud":[49], 
    ...
    "quiz":[56], 
    "flashlight":[57], 
    "actionbarcompat-basic":[58], 
    "customnotifications":[59], 
    "cardviewsample":[60], 
    "basicgesturedetect":[61], 
    "timer":[62], 
    "displayingbitmaps":[63], 
    "borderlessbuttons":[64], 
    "datalayer":[65], 
    "camera2basic":[66], 
    "elevationdrag":[67], 
    "skeletonwearableapp":[68], 
    "storageclient":[69], 
    "delayedconfirmation":[70], 
    "alwayson":[71], 
    "horizontalpaging":[72], 
    "slidingtabscolors":[73], 
    "beamlargefiles":[74], 
    "actionbarcompat-styled":[75], 
    "appusagestatistics":[76], 
    "cardemulation":[77], 
    "basicimmersivemode":[78], 
    "watchface":[79], 
    "camera2video":[80], 
    "textswitcher":[81], 
    "mediarouter":[82], 
    "apprestrictions":[83], 
    "bluetoothadvertisements":[84], 
    "basicaccessibility":[85], 
    "agendadata":[86], 
    "networkconnect":[87], 
    "elizachat":[88], 
    "mediarecorder":[89], 
    "basicmediarouter":[90], 
    "activityscenetransitionbasic":[91], 
    "recipeassistant":[92], 
    "permissionrequest":[93], 
    "batchstepsensor":[94], 
    "floatingactionbuttonbasic":[95], 
    "jumpingjack":[96], 
    "basicmanagedprofile":[97], 
    "gridviewpager":[98], 
    "basicnotifications":[99], 
    "swiperefreshlayoutbasic":[100], 
    "examples":[107], 
    "code":[107]
};
...
var TOOLS_BY_TAG = {
    ...
    "outofmemoryerror":[57], 
    "adk":[63,64,65], 
    "android":[68,69,70,71,72,73,74,75,76,77,78,79,80,81,82], 
    "performance":[68,69,70,71,72,73,74,75,76,77,78,79,80,81,82], 
    "profiling":[68,69,70,71,72,73,74,75,76,77,78,79,80,81,82], 
    "tools":[68,69,70,71,72,73,74,75,76,77,78,79,80,81,82,95], 
    "memoryleaks":[68,77,78,80], 
    "memoryheap":[68,78], 
    "studio":[95,103], 
    "project":[102], 
    "mipmap":[102], 
...
var TRAINING_BY_TAG = {
    "tv":[10,11,12,13,14,15,16,17,18,69,70,72,73,74,75,76,78,80,81,82,84,85,86,88,89,188], 
    "leanback":[10,11,17,69,70,79,80,86], 
    "recyclerview":[10,79], 
    "multiplescreens":[58,190], 
    "wifi":[63], 
    "network":[63,181,236,242,309,350], 
    "wireless":[63,181,309], 
    "cloud":[66,234], 
    "sync":[66], 
    "backup":[66], 
    ...
    "geofence":[110], 
    "geofencing":[110], 
    "activityrecognition":[110], 
    "activitydetection":[110], 
    "gps":[110,235], 
    "animator":[119], 
    "views":[119], 
    "layout":[119,340], 
    "userinterface":[119,289], 
    "print":[126], 
    "navigation":[126,224,247,262], 
    "gesturedetector":[126,262], 
    "scroller":[126,262], 
    "searchview":[132], 
    "database":[132,284], 
    "notifications":[135,136,137,138,139,140,170,171,172,173,174], 
    "wear":[142,143,144,145,146,147,148,172], 
    "":[178], 
    "battery":[181], 
    "appindexing":[185], 
    "tablet":[188], 
    ...
    "ram":[243], 
    "lowmemory":[243], 
    "outofmemoryerror":[243], 
    "ontrimmemory":[243], 
    "drawerlayout":[247], 
    "upnavigation":[248], 
    "navutils":[248,252], 
    "taskstackbuilder":[248,252], 
    "viewpager":[250], 
    "horizontal":[250], 
    "paging":[250], 
    "swipeview":[250], 
    "tabs":[250], 
    "backnavigation":[252], 
    "testing":[253,254,255,256,257,258,377], 
    "uiautomator":[253], 
    "input":[262], 
    "intents":[267,285,286,287,288,302], 
    "work":[274], 
    "enterprise":[274], 
    "corporate":[274], 
    "activitylifecycle":[276,277,278,279,280], 
    "datastorage":[281,282,283,284], 
    "fragments":[289,290,291,292], 
    "layouts":[293,295], 
    "resources":[293,296], 
    "screens":[293], 
    "localization":[293,296], 
    "styles":[294], 
    "strings":[296], 
    "localizing":[296], 
    "actionbar":[297,298,299,300,301], 
    "projectsetup":[303], 
    "sdktools":[304], 
    "emulator":[305], 
    "ui":[306,340], 
    ...
    "oauth":[316], 
    "accounts":[316], 
    "auto":[329,330,331,332], 
    "car":[329,331,332], 
    "automotive":[329,331,332], 
    "messaging":[329], 
    "mapview":[333], 
    "nfcadapter":[336], 
    "androidbeam":[336], 
